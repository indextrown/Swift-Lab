...
//        _sentMessage(
//            #selector(UITextFieldDelegate.textFieldShouldReturn(_:)),
//            withArguments: [textField]
//        )
//
//        let result =
//            (_forwardToDelegate?
...
//        let proxy = RxUITextFieldDelegateProxy.proxy(for: self.base)
//        return proxy
//    }
//    
//    /*
...
//     */
////    var customDelegate: Observable<Bool> {
////        return delegate
////            .methodInvoked(#selector(UITextFieldDelegate.textFieldShouldEndEditing(_:)))
...
//        delegate
//            .sentMessage(#selector(UITextFieldDelegate.textFieldShouldReturn(_:)))
//            .map { _ in () }
//    }
//
//    // MARK: - shouldClear
...
//        delegate
//            .sentMessage(#selector(UITextFieldDelegate.textFieldShouldEndEditing(_:)))
//            .map { _ in () }
//    }
//}
//
